        ...
        <div className="min-h-screen bg-gray-50">
          <Routes>
            ...
            <Route
              ...
              element={
                <ProtectedRoute allowedRoles={[ROLES.FLEET_MANAGER]}>
                  <div><Navbar /><FleetManagerDashboard /></div>
                </ProtectedRoute>
              }
            />
            <Route
            ...
            <Route
              ...
              element={
                <ProtectedRoute allowedRoles={[ROLES.DRIVER]}>
                  <div><Navbar /><DriverDashboard /></div>
                </ProtectedRoute>
              }
            />
            ...
            <Route
              ...
              element={
                <ProtectedRoute allowedRoles={[ROLES.CUSTOMER]}>
                  <div><Navbar /><CustomerDashboard /></div>
                </ProtectedRoute>
              }
            />
            ...
            <Route
              ...
              element={
                <ProtectedRoute allowedRoles={[ROLES.CUSTOMER]}>
                  <div><Navbar /><RouteOptimizationPage /></div>
                </ProtectedRoute>
              }
            />
